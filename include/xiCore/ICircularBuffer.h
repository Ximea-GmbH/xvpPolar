...
enum ExStorageTableCols
{
	...
	StorageColType,				//!< column with storage type selection cobobox
	StorageColPath,				//!< column with path for storate
};
